...
eloqua_results_directory = r'C:\Users\isaama2\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\\Python 3.7\Test Programs\Test Attachments'
##email_subject = 'Working with Global Analytics and Insights Team Checklist (002)'
##
##def saveattachments(email_subject, eloqua_results_directory):
##    path = os.path.expanduser(eloqua_results_directory)
##    print(path)
...
##                break
##            
##saveattachments(email_subject, eloqua_results_directory)
##
##
##
...
eloqua_results = r'C:\Users\isaama2\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Python 3.7\Test Programs\Test Attachments\Email List Results Sent to POA Team\Test'
...
def dictionary_creater(eloqua_results_directory):
    os.chdir(eloqua_results_directory)
...
dictionary_creater(eloqua_results_directory)
...
##def attachment_combiner(df, eloqua_results):
...
##
##attachment_combiner(df, eloqua_results)
